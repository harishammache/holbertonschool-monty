 ...
 *     Avant de retirer l'élément, la fonction vérifie si la pile n'est pas vide.
 ...
 *     La fonction met ensuite à jour les pointeurs pour maintenir la structure de la pile.
 */
